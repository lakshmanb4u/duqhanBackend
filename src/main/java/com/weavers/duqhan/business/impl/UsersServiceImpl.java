...
public class UsersServiceImpl implements UsersService {
    ...
    public UserBean updateUserProfile(Users user, UserBean userBean1) {
        ...
        if (!Objects.isNull(userBean1.getEmail()) && userBean1.getEmail() != null && (exsistUser == null || exsistUser.getId().equals(user.getId()))) { // whether user present with that email or not. 
